...
<div class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="cf" style="float: left;">
		<div class="fl" style="float: right;">
			...
			<a class="btn btn-success " type="button" href="<?php echo U('Index/dayin_all');?>" style="margin-left:20px;">打印所有记录</a>
			<!--<a class="btn btn-success " type="button" href="<?php echo U('In/index');?>" style="margin-left:20px;">打印所有记录</a>-->
		</div>
		<div>
			<form action="<?php echo U('Index/sousuo');?>" method="post">

				创建日期：
				<input type="text" name="time1" class="text date"  placeholder="请选择时间" />
				<input type="text" name="time2" class="text date" placeholder="请选择时间" />
		...
		<!--<a href="<?php echo U('Index/index');?>" style="background: #fff2f2;color:#e4393c">< 主要信息 丨</a>-->
		<!--<a href="<?php echo U('Index/next_index',array('PHPSESSID'=>'rd23sbgojojkgfanu9bhh87m94','p'=>$now));?>" style="color:#005ea7">更多信息 ></a>-->
	</div>
        <br>
		<!-- 数据列表 -->
				...
				<tbody>
					<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									...
									<!--<br />-->
									<a href="<?php echo U('Index/bianji',array('id'=>$vo['id']));?>" >查看/更新</a>
									<a href="<?php echo U('Index/delete',array('id'=>$vo['id']));?>" >删除</a>
