...
<div class="navbar navbar-inverse navbar-fixed-top">
	...
	<form action="<?php echo U(Index/bianji3);?>" method="post" style="padding-top:20px">
		<div class="bianji">
			<span>项目名称</span>

			<input type="text" name="name" value="<?php echo ($result_1['0']['name']); ?>"  readonly="true"/>
		</div>
		<div class="bianji">
			<span>项目分类：</span>
			<select name="fenlei">
				...
				<?php if(is_array($fenlei)): $i = 0; $__LIST__ = $fenlei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fenlei): $mod = ($i % 2 );++$i;?><option value='<?php echo ($fenlei['name']); ?>'     <?php if($result_1['0']['fenlei'] == $fenlei['name']): ?>selected="selected"<?php endif; ?>><?php echo ($fenlei["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
		</div>
		<div class="bianji">
			<span>项目位置：</span>
			<input type="text" name="location"  value="<?php echo ($result_1['0']['location']); ?>"/>
		</div>
		<div class="bianji">
			<span>项目单位</span>
			<div class="controls">
		...
		<div class="bianji1"><span></span>
			...
			<div class="bianji">
			<span>责任人：</span>
			<input type="text" name="man" value="<?php echo ($result_1['0']['man']); ?>" />
		</div>
		<div class="bianji">
			<span>
				联系电话：
			</span>
			<input type="text" name="phone"  value="<?php echo ($result_1['0']['phone']); ?>"/>
		</div>
		<div class="bianji">
			<span>
				目前工作进展情况：
			</span>
			<input type="text" name="work_progress" value="<?php echo ($result_1['0']['work_progress']); ?>"/>
		</div>
		<div class="bianji">
			<span>下一步打算：</span>
			<input type="text" name="next_plan"value="<?php echo ($result_1['0']['next_plan']); ?>" />
		</div>
		<div class="bianji" style="height:150px;">
			<span>存在问题：</span>
			<textarea name="problem"><?php echo ($result_1['0']['problem']); ?></textarea>
		</div>
	<div class="bianji">
				<span>项目建设年度</span>
			<div class="controls">
				<input class="text input-large" type="text" name="construction_year" value="<?php echo ($result_1['0']['construction_year']); ?>" />
			</div>
		...
		<div class="bianji">
			<span>建设内容</span>
			<div class="controls">
				<input class="text input-large" type="text" name="construction_content" value="<?php echo ($result_1['0']['construction_content']); ?>" />
			</div>
		...
		<div class="bianji">
			<span>本月周进度计划安排</span>
			<div class="controls">
				<input class="text input-large" type="text" name="current_week" value="<?php echo ($result_1['0']['current_week']); ?>" />
			</div>
		</div>
		<div class="bianji">
			<span>立项手续完成时间及文号</span>
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time1" value="<?php echo ($result_1['0']['finish_time1']); ?>" />
			</div>
		</div>
		<div class="bianji">
			<span>可研手续完成时间及文号</span>
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time2" value="<?php echo ($result_1['0']['finish_time2']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time3" value="<?php echo ($result_1['0']['finish_time3']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time4" value="<?php echo ($result_1['0']['finish_time4']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time5" value="<?php echo ($result_1['0']['finish_time5']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time6" value="<?php echo ($result_1['0']['finish_time6']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time7" value="<?php echo ($result_1['0']['finish_time7']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time8" value="<?php echo ($result_1['0']['finish_time8']); ?>" />
			</div>
		...
		<div class="bianji">
			<span>完成设计招标时间</span>
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time9" value="<?php echo ($result_1['0']['finish_time9']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time10" value="<?php echo ($result_1['0']['finish_time10']); ?>" />
			</div>
		...
		<div class="bianji">
			<span>建设周期</span>
			<div class="controls">
				<input class="text input-large" type="text" name="finish_time11" value="<?php echo ($result_1['0']['finish_time11']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_01" value="<?php echo ($result_1['0']['plan_01']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_02" value="<?php echo ($result_1['0']['plan_02']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_03" value="<?php echo ($result_1['0']['plan_03']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_04" value="<?php echo ($result_1['0']['plan_04']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_05" value="<?php echo ($result_1['0']['plan_05']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_06" value="<?php echo ($result_1['0']['plan_06']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="plan_07" value="<?php echo ($result_1['0']['plan_07']); ?>" />
			</div>
		...
		<div class="bianji">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="money_need" value="<?php echo ($result_1['0']['money_need']); ?>" />
			</div>
		...
		<div class="bianji">
			<span>2017年计划安排</span>
			<div class="controls">
				<input class="text input-large" type="text" name="next_year_plan" value="<?php echo ($result_1['0']['next_year_plan']); ?>" />
			</div>
		...
		<div class="bianji">
			<span>2017年资金需求</span>
			<div class="controls">
				<input class="text input-large" type="text" name="money_need_next" value="<?php echo ($result_1['0']['money_need_next']); ?>" />
			</div>
		</div>
		<div class="form-item">
            ...
            <div class="controls condition">
                <label class="checkbox">
					<input type="checkbox" name="help" value="是"
						<?php if($result_1['0']['help'] == '是'): ?>checked<?php endif; ?>
					/>
					是否需要协调
                </label>
                <label class="checkbox">
					<input type="checkbox" name="action" value="是" 
						<?php if($result_1['0']['action'] == '是'): ?>checked<?php endif; ?>
					/>
					是否开工 
				</label>
				<label class="checkbox">
			...
			<div class="project_sort_item">
				<label class="checkbox">
					<input type="checkbox" name="major" value="是"  
						<?php if($result_1['0']['major'] == '是'): ?>checked<?php endif; ?>
					/>
					市重点项目
				</label>
				<label class="checkbox">
					<input type="checkbox" name="major2" value="是"  
						<?php if($result_1['0']['major2'] == '是'): ?>checked<?php endif; ?>
					/>
					市政务办现场会项目 
				</label>
				<label class="checkbox">
					<input type="checkbox" name="major3" value="是" 
						<?php if($result_1['0']['major3'] == '是'): ?>checked<?php endif; ?> 					/>
					区重点项目 
				</label>
				<label class="checkbox">
					<input type="checkbox" name="major4" value="是"  
						<?php if($result_1['0']['major4'] == '是'): ?>checked<?php endif; ?>
					/>
					区局联席会项目
				</label>
				<label class="checkbox">
		...
		<input type="hidden" name="xiangmu_id" value="<?php echo ($result_1['0']['xiangmu_id']); ?>">
		<input type="hidden" name="id" value="<?php echo ($result_1['0']['id']); ?>">
