...
<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <form action="<?php echo U(Index/bianji4);?>" method="post">

        <div class="bianji">
            <span>项目名称：</span>
            <input type="text" name="name"value="<?php echo ($result_1['name']); ?>"  readonly="true"/>
        </div>
        ...
        <div class="bianji">
            <span>项目位置：</span>
            <input type="text" name="location"value="<?php echo ($result_1['location']); ?>"  />
        </div>
        <div class="bianji">
            <span>项目单位</span>
            <div class="controls">
        ...
        <div class="bianji">
            <span>责任人：</span>
            <input type="text" name="man"value="<?php echo ($result_1['man']); ?>"  />
        </div>
        <div class="bianji">
            <span>联系电话：</span>
            <input type="text" name="phone"value="<?php echo ($result_1['phone']); ?>"  />
        </div>
        <div class="bianji">
            <span>目前工作进展情况：</span>
            <input type="text" name="work_progress"value="<?php echo ($result_1['work_progress']); ?>"  />
        </div>

        <div class="bianji">
            <span>下一步打算：</span>
            <input type="text" name="next_plan"value="<?php echo ($result_1['next_plan']); ?>"  />
        </div>
        ...
        <div class="controls condition">
            <label class="checkbox">
                ...
                <label class="checkbox">
                    ...
                    <?php if($result_1['action'] == '是'): ?>checked<?php endif; ?>
                    />
                    是否开工
                </label>
            <label class="checkbox">
                <input type="checkbox" name="shenpi" value="是"
                <?php if($result_1['shenpi'] == '是'): ?>checked<?php endif; ?>
                />
                是否通过审批
            </label>
                </div>
        ...
        <div class="project_sort">
            ...
            <div class="project_sort_item">
                <label class="checkbox">
                    ...
                    <?php if($result_1['major'] == '是'): ?>checked<?php endif; ?>
                    />
                    市重点项目
                </label>
                <label class="checkbox">
                    <input type="checkbox" name="major2" value="是"
                    <?php if($result_1['major2'] == '是'): ?>checked<?php endif; ?>
                    />
                    市政务办现场会项目
                </label>
                ...
                <label class="checkbox">
                    ...
                    <?php if($result_1['major3'] == '是'): ?>checked<?php endif; ?>
                    />
                    区重点项目
                </label>
                ...
                <label class="checkbox">
                    ...
                    <?php if($result_1['major4'] == '是'): ?>checked<?php endif; ?>
                    />
                    区局联席会项目
                </label>
                <label class="checkbox">
                    <input type="checkbox" name="haimian" value="是"
                    <?php if($result_1['haimian'] == '是'): ?>checked<?php endif; ?>
                    />
                    海绵城市建设项目
                </label>
            ...
            <input type="hidden" name="id" value="<?php echo ($result_1['xiangmu_id']); ?>">
