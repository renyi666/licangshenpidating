		...
		<div>
			<form action="<?php echo U('Xiangmu/sousuo');?>" method="post">
				...
				责任人：
					...
					<option value=''></option>
				<?php if(is_array($q)): $i = 0; $__LIST__ = $q;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$q): $mod = ($i % 2 );++$i;?><option value=' <?php echo ($q['man']); ?>'><?php echo ($q["man"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
				</br></br>
