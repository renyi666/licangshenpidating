...
<body>
    ...
    <form class="form-horizontal" action="<?php echo U(Xiangmu/company_member_xinjian);?>" method="post">


        <div class="form-item">
            <label class="item-label">用户uid</label>
            <div class="controls">
                <input class="text input-large" type="text" name="user_uid"/>
            </div>
<input type="text" name="duty_id" hidden value="<?php echo ($con['uid']); ?>">
        </div>
