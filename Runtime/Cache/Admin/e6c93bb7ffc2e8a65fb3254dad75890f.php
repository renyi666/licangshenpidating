...
<body>
	...
	<div class="cf">
		...
		<div>
			<form action="<?php echo U('Xiangmu/sousuo');?>" method="post">
				...
				<!--<option value=''></option>-->
				<!--<?php if(is_array($q)): $i = 0; $__LIST__ = $q;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$q): $mod = ($i % 2 );++$i;?>-->
				<!---->
				<!--<option value=' <?php echo ($q['man']); ?>'><?php echo ($q["man"]); ?></option>-->
		...
		<div>
			...
			<!--<a class="btn btn-success " type="button"  href="<?php echo U('Xiangmu/dayin_all1');?>">打印所有记录</a>-->
	...
	<!--<div class="cf">-->
		<!--<div class="fl">-->
                ...
                <!--<a  class="btn" href="<?php echo U('Xiangmu/dayin_sousuo');?>">打印当前记录</a>-->
   ...
   <!--</div><br/>-->
	...
	<!---->
       ...
       <!--<form action="<?php echo U('Xiangmu/sousuo');?>" method="post">-->
		   <!--项目名称:<input type="text" name="name">-->
        	<!--分类：<select name="fenlei"id="fenlei">-->
				<!--<option value=''></option>-->
        ...
        <!--&lt;!&ndash; 高级搜索 &ndash;&gt;-->
		<!--<div class="search-form fr cf">			<div class="sleft">-->
				<!--<input type="text" name="id" class="search-input" value="<?php echo I('id');?>" placeholder="请输入项目编号">-->
				<!--<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('index');?>"><i class="btn-search"></i></a>-->
			<!--</div>-->
		<!--</div>-->
