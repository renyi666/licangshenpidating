...
<body>
	...
	<form class="form-horizontal" action="<?php echo U(Xiangmu/company_bianji);?>" method="post">
		<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><div class="form-item">
			<label class="item-label">单位id</label>
			<div class="controls">
				<input class="text input-large" type="text" name="id" value="<?php echo ($res['id']); ?>"  readonly />
			</div>
		...
		<div class="form-item">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="name" value="<?php echo ($res['name']); ?>"/>
			</div>

		</div>
		<div class="form-item">
			<label class="item-label">管理员账户</label>
			<div class="controls">
				<input class="text input-large" type="text" name="user_uid" value="<?php echo ($res['user_uid']); ?>"  />
			</div>

		</div><?php endforeach; endif; else: echo "" ;endif; ?>

		<input type="submit" name="save" value="保存" />
		<a href="<?php echo U('Xiangmu/company');?>">取消</a>
	</form>
