							...
							<li>
								<div class="col-sm-6 ">
									<div class="row">
										...
										<div class="col-sm-8 bianji_right">
											<h5 contenteditable="true"><input type="text" class="form-control" name="location" value="<?php echo ($r1['location']); ?>"style=" margin-top: 0px;"></h5>
										</div>
									</div>
								</div>
							</li>
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-8 bianji_right">
                                            ...
                                            <!--<select name="fenlei">-->
                                                ...
                                                <!--<?php if(is_array($list_fenlei)): $i = 0; $__LIST__ = $list_fenlei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list_fen): $mod = ($i % 2 );++$i;?>-->
                                                    <!--<?php echo ($list["name"]); ?>-->
                                                    <!--<option value='<?php echo ($list_fen['name']); ?>'<?php if($list_fen['name'] == $r1['fenlei']): ?>selected<?php endif; ?>><?php echo ($list_fen["name"]); ?></option>-->
                                                <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
                                            <!--</select>-->
								...
								<div class="col-sm-6 ">
									<div class="row">
										...
										<div class="col-sm-8 bianji_right">
											...
											<!--<select name="company" class="select_company">-->


												<!--<?php if(is_array($com)): $i = 0; $__LIST__ = $com;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?>-->

													<!--<option value='<?php echo ($com['company']); ?>'<?php if($r1['company'] == $com['company']): ?>selected="selected"<?php endif; ?>-->

													<!--&gt;<?php echo ($com["company"]); ?></option>-->
												<!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
												<!--&lt;!&ndash;<option value="another" class="another">其他</option>&ndash;&gt;-->
											<!--</select>-->

											<!--<input type="text" class="shuru" name="shuru" placeholder="请输入项目单位" style="display: none">-->
							...
							<li>
								<div class="col-sm-6">
									<div class="row">
										...
										<div class="col-sm-8 bianji_right">
											<h5 contenteditable="true"title="<?php echo ($r1["total_money"]); ?>"><input type="text" class="form-control" name="total_money" value="<?php echo ($r1['total_money']); ?>" ></h5>
										</div>
									</div>
								</div>
							</li>
				...
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="row jieduan">
					...
					<table class="jieduan_cont">
						...
						<?php if(is_array($data['item'])): $i = 0; $__LIST__ = $data['item'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="th3"><a href="#"class="luru">更新</a></td>
