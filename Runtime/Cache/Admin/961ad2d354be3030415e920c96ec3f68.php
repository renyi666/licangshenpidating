...
<body>
    ...
    <div class="main-title">
        <h2>用户列表</h2>
    </div><a class="btn" href="<?php echo U('Xiangmu/company_member_xinjian',array('uid'=>$need['uid']));?>">新增下属</a>
    <div class="cf">
        <div class="fl">
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["0"]["uid"]); ?> </td>
                        <td><?php echo ($vo["0"]["nickname"]); ?></td>
                        <td><?php echo ($vo["0"]["work_place"]); ?></td>
                        <td><?php echo ($vo["0"]["score"]); ?></td>
                        <td><?php echo ($vo["0"]["login"]); ?></td>
                        <td><?php echo ($vo["0"]["first_time"]); ?></td>
                        <td><span><?php echo (time_format($vo["0"]["last_login_time"])); ?></span></td>

                        <td>
                            <a href="<?php echo U('Xiangmu/company_chakan_delete',array('uid'=>$vo['0']['uid']));?>" >删除</a>
