...
<body>
    ...
    <h3></h3><br />			<a class="btn" href="<?php echo U('Xiangmu/company_xinjian');?>">新建责任单位</a>
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["nickname"]["0"]["nickname"]); ?></td>


                        <td>
                            <eq name="vo.status" value="1">
                                <!--<a href="<?php echo U('Xiangmu/company_chakan',array('id'=>$vo['id']));?>" >查看旗下用户</a>-->

                                <a href="<?php echo U('Xiangmu/company_bianji',array('id'=>$vo['id']));?>" >编辑</a>

                                <a href="<?php echo U('Xiangmu/company_delete',array('id'=>$vo['id']));?>" >删除</a>
                        </td>
