...
<body>
    ...
    <div class="cf">
        ...
        <div>
            <form action="<?php echo U('Next/sousuo');?>" method="post">
                分类：
        ...
        <div>
            <a class="btn" href="<?php echo U('Next/dayin_all');?>">打印所有记录</a>
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <tr>
                ...
                <!--<th class="">责任人</th>-->
                <!--<th class="">联系电话</th>-->
                <!--&lt;!&ndash;<th class="">最后登录IP</th>&ndash;&gt;-->
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["finish_time6"]); ?></td>
                        <td><?php echo ($vo["finish_time7"]); ?></td>
                        <td><?php echo ($vo["finish_time8"]); ?></td>
                        <td><?php echo ($vo["finish_time9"]); ?></td>
                        <td><?php echo ($vo["finish_time10"]); ?></td>
                        <td><?php echo ($vo["finish_time11"]); ?></td>
                        ...
                        <td>
                            <eq name="vo.status" value="1">
                                <a href="<?php echo U('Next/xiangmu_copy_chakan',array('id'=>$vo['id'],'name'=>$vo['name'],'fenlei'=>$vo['fenlei']));?>" >查看</a>

                                <a href="<?php echo U('Next/bianji',array('id'=>$vo['id'],'name'=>$vo['name'],'fenlei'=>$vo['fenlei'],'man'=>$vo['man'],'company'=>$vo['company'],'location'=>$vo['location'],'phone'=>$vo['phone'],'work_progress'=>$vo['work_progress'],'next_plan'=>$vo['next_plan'],'problem'=>$vo['problem']));?>" >更新</a>

                                <!--<a href="<?php echo U('Next/delete',array('id'=>$vo['id']));?>" >删除</a>-->
                        </td>
