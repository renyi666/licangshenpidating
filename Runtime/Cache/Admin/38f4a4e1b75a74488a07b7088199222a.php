...
<head>
    ...
    <link href="/aaaa/Public/Admin/css/datepicker3.css" rel="stylesheet">
    <link href="/aaaa/Public/Admin/css/styles.css" rel="stylesheet">
...
<body>
	...
	<div class="cf">
		<div class="fl">
            ...
            <a class="btn" href="<?php echo U('bianji2',array('id'=>$a['xiangmu_id'],'name'=>$a['name'],'fenlei'=>$a['fenlei'],'man'=>$a['man'],'company'=>$a['company'],'location'=>$a['location'],'phone'=>$a['phone'],'work_progress'=>$a['work_progress'],'next_plan'=>$a['next_plan'],'problem'=>$a['problem']));?>">新建更新状态</a>
                    <a class="btn" href="<?php echo U('dayin_current',array('xiangmu_id'=>$a['xiangmu_id'],'name'=>$a['name'],'fenlei'=>$a['fenlei'],'man'=>$a['man'],'company'=>$a['company'],'location'=>$a['location'],'phone'=>$a['phone'],'work_progress'=>$a['work_progress'],'next_plan'=>$a['next_plan'],'problem'=>$a['problem']));?>">打印当前记录</a>

        </div>
 	
        <form action="<?php echo U('Xiangmu/sousuo_xiangmu_copy');?>" method="post">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><eq name="vo.status" value="1">
                ...
                <a href="<?php echo U('Xiangmu/xiangmu_copy_delete',array('id'=>$vo['id']));?>" >删除</a>
                </td>
