...
<body>
	...
	<!--<div class="cf">-->
		...
		<!--<div>-->
			<!--<form action="<?php echo U('Xiangmu/sousuo');?>" method="post">-->
				...
				<!--<?php if(is_array($fenlei)): $i = 0; $__LIST__ = $fenlei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fenlei): $mod = ($i % 2 );++$i;?>-->
					<!--<option value='<?php echo ($fenlei['name']); ?>'><?php echo ($fenlei["name"]); ?></option>-->
			...
			<!--&lt;!&ndash;&ndash;&gt;-->
				...
				<!--&lt;!&ndash;<?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company): $mod = ($i % 2 );++$i;?>&ndash;&gt;-->
					<!--&lt;!&ndash;<option value='<?php echo ($company['company']); ?>'><?php echo ($company["company"]); ?></option>&ndash;&gt;-->
					<!--&lt;!&ndash;<?php endforeach; endif; else: echo "" ;endif; ?>&ndash;&gt;-->
			<!--&lt;!&ndash;</select>&ndash;&gt;-->
				<!--&lt;!&ndash;责任人：&ndash;&gt;-->
					<!--&lt;!&ndash;<select name="man"id="man">&ndash;&gt;-->
					<!--&lt;!&ndash;<option value=''></option>&ndash;&gt;-->
				<!--&lt;!&ndash;<?php if(is_array($q)): $i = 0; $__LIST__ = $q;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$q): $mod = ($i % 2 );++$i;?>&ndash;&gt;-->
					<!--&lt;!&ndash;&ndash;&gt;-->
					<!--&lt;!&ndash;<option value=' <?php echo ($q['man']); ?>'><?php echo ($q["man"]); ?></option>&ndash;&gt;-->
					<!--&lt;!&ndash;<?php endforeach; endif; else: echo "" ;endif; ?>&ndash;&gt;-->
			<!--&lt;!&ndash;</select>&ndash;&gt;-->
				<!--</br></br>-->
				...
				<!--&lt;!&ndash;<input type="checkbox" name="new" value="是" />&ndash;&gt;-->
				<!--&lt;!&ndash;显示最新进展情况	</br>&ndash;&gt;-->
                <!--<div class="form-item">-->
		...
		<!--<div>-->
			<!--<a class="btn" href="<?php echo U('Xiangmu/dayin_disan',array('company'=>$map['company']));?>">打印所有记录</a>-->
	...
	<!--<div class="cf">-->
		...
		<div><a class="btn btn-warning " type="button"   id="test"href="<?php echo U('Xiangmu/dayin_xuanze');?>">打印所选记录</a>
			<a class="btn btn-success " type="button"  href="<?php echo U('Xiangmu/dayin_disan',array('company'=>$map['company']));?>">打印所有记录</a>
			...
			<tbody>
				<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<eq name="vo.status" value="1">
								...
								<!--<a href="<?php echo U('Xiangmu/bianji',array('id'=>$vo['id'],'name'=>$vo['name'],'fenlei'=>$vo['fenlei'],'man'=>$vo['man'],'company'=>$vo['company'],'location'=>$vo['location'],'phone'=>$vo['phone'],'work_progress'=>$vo['work_progress'],'next_plan'=>$vo['next_plan'],'problem'=>$vo['problem']));?>" >更新</a>-->
