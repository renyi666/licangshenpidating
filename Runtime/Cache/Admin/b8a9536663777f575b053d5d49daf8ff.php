...
<body>
	...
	<form class="form-horizontal" action="<?php echo U(Next/bianji);?>" method="post">
		<div class="form-item">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input class="text input-large" type="text" name="company" value="<?php echo ($result_1['company']); ?>"  />
			</div>
		...
		<div class="form-item">
			...
			<div class="controls">
				<label class="checkbox">
					...
					<?php if($result_1['help'] == '是'): ?>checked<?php endif; ?> />是否需要协调
				</label>
				<label class="checkbox">
					<input type="checkbox" name="action" value="是" <?php if($result_1['action'] == '是'): ?>checked<?php endif; ?>/>
					是否开工
				</label>
		...
		项目类别：
		<input type="checkbox" name="major" value="是"  <?php if($r1['major'] == '是'): ?>checked<?php endif; ?>/>
		市重点项目
		...
		区重点项目
		<input type="checkbox" name="major4" value="是"  <?php if($r1['major4'] == '是'): ?>checked<?php endif; ?>/>
		...
		<input type="text"  name="res_id" hidden value="<?php echo ($res_id); ?>">
